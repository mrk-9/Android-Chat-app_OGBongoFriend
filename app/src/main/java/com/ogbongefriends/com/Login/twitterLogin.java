...
//	AlertDialogManager alert = new AlertDialogManager();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.twitter_signup);
		...
		if (!Utils.isNetworkConnectedMainThred(twitterLogin.this)) {
			// Internet Connection is not present
			Utils.alert(twitterLogin.this, R.string.error, "Please connect to working Internet connection");
		...
		if(TWITTER_CONSUMER_KEY.trim().length() == 0 || TWITTER_CONSUMER_SECRET.trim().length() == 0){
			// Internet Connection is not present
			Utils.alert(twitterLogin.this, R.string.error, "Please set your twitter oauth tokens first!");
			// stop executing code by return
			return;
		}
		...
		if (!isTwitterLoggedInAlready()) {
			...
			if (uri != null && uri.toString().startsWith(TWITTER_CALLBACK_URL)) {
				...
				try {
					...
					String firstname = user.getScreenName();
					...
					Intent returnIntent = new Intent(twitterLogin.this, LoginActivity.class);
