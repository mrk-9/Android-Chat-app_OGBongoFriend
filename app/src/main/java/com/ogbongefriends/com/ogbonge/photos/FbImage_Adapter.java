...
public abstract class FbImage_Adapter extends BaseAdapter {
    ...
    public FbImage_Adapter(Context context, ArrayList<HashMap<String, String>> placeData) {
    ...
    public View getView(int index, View view, final ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.fb_album_images, parent, false);
        }
...
//count.setText(row.get("count"));
        ...
        img.setScaleType(ScaleType.FIT_XY);
        imageLoader.displayImage(row.get("source"), img, new ImageLoadingListener() {
