...
@SuppressLint("NewApi") public class WhoFavYou extends Fragment implements Runnable,MyLocationListener,OnClickListener {
...
//	private String followintType;
  ...
  private int category_type=1,search_page_index=2;
  ...
  String[] listContent = { "Name","Location"};
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		NotificationType.someone_favd_you_notification=0;
		if(rootView==null){
		...
		promote_yourself=(ImageView)rootView.findViewById(R.id.promote_yourself);
		 ...
		 db.open();
			db.delete(DB.Table.Name.notification_master, DB.Table.notification_master.uuid.toString()+" = '"+pref.get(Constants.KeyUUID)+"' AND type=7", null);
		
		//msg_to_fav.setText("people fav'd you. See if you fav'd them too.");
		
		File cacheDir = StorageUtils.getCacheDirectory(_ctx);
				
				
				 options = CelUtils.getImageOptionBlur();
