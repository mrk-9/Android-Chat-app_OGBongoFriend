...
public class verification_api extends BasicApi implements Runnable {
...
//	private SharedPreferences pref;
	...
	public verification_api(Context ctx, DB db, CustomLoader p) {
		super(ctx, db);
		this.db = db;
		this.ctx = ctx;
		this.p = p;
		// url = "http://tmwtg.com/tmwtg/Cpanels/signup";
		url = Utils.getCompleteApiUrl(ctx, R.string.userVerification);
