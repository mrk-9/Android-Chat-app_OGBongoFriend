...
public class Registration_2_Api extends BasicApi implements Runnable {
...
//	private SharedPreferences pref;
	...
	public Registration_2_Api(Context ctx, DB db, CustomLoader p) {
		super(ctx, db);
		this.db = db;
		this.ctx = ctx;
		this.p = p;
		// url = "http://tmwtg.com/tmwtg/Cpanels/signup";
		url = Utils.getCompleteApiUrl(ctx, R.string.registration_2_api);
