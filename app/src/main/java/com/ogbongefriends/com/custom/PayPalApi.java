...
public abstract class PayPalApi {
    ...
    //===
    public PayPalApi(Context ctx, DB db) {
        this.dbb = db;
        this.ctx = ctx;
    }
    ...
    public void toBeSaved(boolean bsave) {
        save = bsave;
    }
    ...
    public void postData(String purl, String data) {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Bearer A015y7fPXOFRMiTL5N14ixULchn1xVdEoE2gdJwJu1ncQ8g");
